<template>
  <div>
    <header style="z-index:2;">
        <nav class="navbar navbar-expand-lg navbar-light bg-white align-items-center p-0 container-fluid" style="height: 8vh;">
            <a class="navbar-brand ms-4 h-100">
            ...
            <div class="collapse navbar-collapse text-center" id="navbarNav">
                <ul class="navbar-nav mr-auto me-auto">
                    ...
                    <li><hr class="border border-primary border-1 col-1 mx-auto opacity-100 m-0 linea"></li>
                    <div v-if="this.log">
                        <li class="nav-item" >
    ...
    <router-view style="height: 86vh; z-index:0;" class="bg-success" />

    <footer class="text-muted container-fluid px-md-5 align-items-center" style="height: 6vh">
            ...
            <div class="collapse navbar-collapse text-center h-100" id="navbarNav">
                ...
                <ul class="navbar-nav ml-auto align-items-center h-100">
                    <li class="nav-item me-2">
                        <a href="https://twitter.com/miperfil">
        ...
        <div class="d-block d-md-none h-100 pb-1">
            <button class="col-3 btn text-center">Log In</button>
