<template>
  <div>
          ...
          <div class="collapse navbar-collapse divNav" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-3 ">
              <li v-if="isLoggedIn" class="nav-item d-md-none d-block pt-2">
                ...
                <router-link to="/" class="fw-bold text-decoration-none" style="color: #205760" aria-current="page" href="#"> Mi cuenta</router-link>
            ...
            <ul class="navbar-nav d-none d-md-flex" v-if="isLoggedIn">
              ...
              <li class="nav-item">
                <router-link to="/" class="nav-link fw-bold" style="color: #205760" aria-current="page" href="#">Mi cuenta</router-link>
              </li>
            ...
            <ul class="navbar-nav d-none d-md-flex" v-else>
              <img src="../src/assets/llaveVerde.png" class="mt-1" height="30">
              <li class="nav-item">
                <a class="nav-link fw-bold" style="color: #205760" aria-current="page" href="/Login">Login</a>
              </li>
              <li class="nav-item fw-bold ">
                <a class="nav-link" style="color: #205760" aria-current="page" href="#">/</a>
              </li>
    ...
    <router-view style="min-height: 90vh;width:100%;" />
